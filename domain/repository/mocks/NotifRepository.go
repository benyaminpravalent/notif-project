...
// NewNotifRepository creates a new instance of NotifRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNotifRepository(t testing.TB) *NotifRepository {
	mock := &NotifRepository{}
	mock.Mock.Test(t)
